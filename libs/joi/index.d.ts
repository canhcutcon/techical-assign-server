declare namespace Joi {
    interface Root {
        /**
         *  Declare new type here
         *  Start ----------------------------------------------------------------
         */
        objectId<TSchema = string>(): StringSchema<TSchema>;
        ethAddress<TSchema = string>(): StringSchema<TSchema>;
        doesNotContainUrlsString<TSchema = string>(): StringSchema<TSchema>;
        pagination<TSchema = any, isStrict = false, T = TSchema>(schema?: SchemaMap<T, isStrict>): ObjectSchema<TSchema>;
        unsafePagination<TSchema = any, isStrict = false, T = TSchema>(schema?: SchemaMap<T, isStrict>): ObjectSchema<TSchema>;
        paginationWithSort<TSchema = any, isStrict = false, T = TSchema>(schema?: SchemaMap<T, isStrict>, sortBy?: string[]): ObjectSchema<TSchema>;
        unsafePaginationWithSort<TSchema = any, isStrict = false, T = TSchema>(schema?: SchemaMap<T, isStrict>, sortBy?: string[]): ObjectSchema<TSchema>;
        ethTxHash<TSchema = string>(): StringSchema<TSchema>;
